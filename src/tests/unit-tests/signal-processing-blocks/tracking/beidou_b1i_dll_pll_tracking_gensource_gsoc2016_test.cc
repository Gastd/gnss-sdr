...
void BeiDouB1iDllPllTrackingGenSourceTest::init()
{
    ...
    config->set_property("Tracking_1I.implementation", "BeiDou_B1i_DLL_PLL_Tracking");
    config->set_property("Tracking_1I.item_type", "gr_complex");
    config->set_property("Tracking_1I.dump", "false");
    config->set_property("Tracking_1I.dump_filename", "./beidou_tracking_ch_");
    config->set_property("Tracking_1I.early_late_space_chips", "0.5");
    config->set_property("Tracking_1I.order", "2");
    config->set_property("Tracking_1I.pll_bw_hz", "20.0");
    config->set_property("Tracking_1I.dll_bw_hz", "5.0");
    config->set_property("Tracking_1I.pll_bw_narrow_hz", "2.0");
    config->set_property("Tracking_1I.pll_bw_narrow_hz", "2.0");
    config->set_property("Tracking_1I.ti_ms", "1");
}
...
TEST_F(BeiDouB1iDllPllTrackingGenSourceTest, ValidationOfResults)
{
    ...
    std::shared_ptr<GNSSBlockInterface> trk_ = factory->GetBlock(config, "Tracking_1I", "BeiDou_B1i_DLL_PLL_Tracking", 1, 1);
