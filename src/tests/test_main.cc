...
#include "unit-tests/signal-processing-blocks/acquisition/beidou_B1I_pcps_acquisition_gensource_gsoc2016_test.cc"
...
#include "unit-tests/signal-processing-blocks/tracking/beidou_b1i_dll_pll_tracking_gensource_gsoc2016_test.cc"
